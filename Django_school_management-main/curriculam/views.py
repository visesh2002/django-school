...
class LessonDetailView(DetailView, FormView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('curriculam:lesson_detail',kwargs={'standard':standard.slug,
...
class LessonCreateView(CreateView):
    ...
    model= Subject
    template_name = 'curriculam/lesson_create.html'

    def get_success_url(self):
        self.object = self.get_object()
        standard = self.object.standard
        return reverse_lazy('curriculam:lesson_list',kwargs={'standard':standard.slug,
                                                             'slug':self.object.slug})
...
class LessonUpdateView(UpdateView):
    ...
    model= Lesson
    template_name = 'curriculam/lesson_update.html'
    context_object_name = 'lessons'

class LessonDeleteView(DeleteView):
    model= Lesson
    context_object_name = 'lessons'
    template_name = 'curriculam/lesson_delete.html'

    def get_success_url(self):
        print(self.object)
        standard = self.object.Standard
        subject = self.object.subject
        return reverse_lazy('curriculam:lesson_list',kwargs={'standard':standard.slug,'slug':subject.slug})